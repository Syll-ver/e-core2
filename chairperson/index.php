...
.badge-light{
  ...
  <ul class="navbar-nav flex-row ml-md-auto d-none d-md-flex">
      ...
      <div class="dropdown-menu dropdown-menu-right" aria-labelledby="notifdropdown">
        ...
        if(count($rows) > 0){
          foreach($rows as $i){
            ...
            if($i['type'] == 'cut-off'){
              echo $i['sender']." set the cut-off score for course".$course['get_coursecode'];
    ...
    <li class="nav-item dropdown">
      <a class="nav-item nav-link dropdown-toggle mr-md-2" href="#" id="bd-versions" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"> <?php echo $user; ?>
                      ...
                      <tbody>
                        ...
                        while ($row = $result->fetch(PDO::FETCH_ASSOC)) {
                          ...
                          if($row['status'] === 'reserved'){
                            echo "<td><button class='btn button' onclick=\"location.href='includes/enroll.php?id=".urlencode($row['student_id'])."'\" type='submit' name='theButton'>Enroll</button></td>";
